-- =====================================================
-- MIGRATION: Update category names + descriptions (marketing copy)
-- Applies to: public.categories
-- Idempotent: safe to re-run.
-- =====================================================

-- 1) Rename legacy category names (avoid leaving old rows behind)
...
-- 2) Upsert desired descriptions + sequence
INSERT INTO public.categories (category, description, sequence, status)
VALUES
  (
