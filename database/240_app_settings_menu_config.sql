...
INSERT INTO public.app_settings_menu (menu_id, label, icon, section, enabled, display_order, requires_login) VALUES
  ...
  ('wallet',        'FNG Wallet',       'wallet',            'main',  true, 4, true),
  ('orders',        'Order History',    'receipt',           'main',  true, 5, true),
  ('cart',          'Cart',             'cart',              'main',  true, 6, false),
  ('coupons',       'Offers & Coupons', 'pricetag',          'main',  true, 7, true),
  ('referral',      'Refer & Rise',     'trophy',            'main',  true, 8, true),
  ('referral_rewards', 'Referral Rewards', 'gift-outline',  'main',  true, 9, true),
  ('notifications', 'Notifications',    'notifications',     'main',  true, 10, false),
