...
export const DAILY_BLOG_TOPICS: DailyBlogTopic[] = [
  ...
  { topic: 'Monsoon car care checklist for Pune and PCMC roads', focusKeyword: 'monsoon car service', intent: 'Local / Navigational' },
  ...
  { topic: 'How to choose a trusted car garage near you in Pune', focusKeyword: 'car garage Pune', intent: 'Local / Navigational' },
  { topic: 'Pickup and drop car service: when doorstep workshop help saves time', focusKeyword: 'car pickup drop service', intent: 'Commercial/Transactional' },
  ...
  { topic: 'How doorstep car service works and what to expect on the visit', focusKeyword: 'doorstep car service', intent: 'Commercial/Transactional' },
  ...
  { topic: 'How to prepare your car before a long highway trip from Pune', focusKeyword: 'highway car checkup', intent: 'Local / Navigational' },
  { topic: 'Pickup boy car collection: photos, checklist and what customers should verify', focusKeyword: 'car pickup inspection', intent: 'Informational' },
