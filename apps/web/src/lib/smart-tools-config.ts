...
export const DEFAULT_SMART_TOOLS: SmartToolRow[] = [
  ...
  { tool_id: 'car_loan', title: 'Loan Against Car', subtitle: 'Instant loan options', tool_type: 'webview', screen_name: 'SmartToolWeb', default_web_url: 'https://myfng.in/car-loan', enabled: true, membership_only: false, allowed_membership_plan_ids: [], requires_login: false, show_on_home: true, show_on_search: true, placements: freshDefaultPlacements(), display_order: 4 },
