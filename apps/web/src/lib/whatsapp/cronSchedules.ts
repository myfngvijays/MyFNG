...
export const WHATSAPP_CRON_JOBS: WhatsAppCronJobDef[] = [
  ...
  {
    id: 'daily-blog-auto-post',
    jobName: 'daily-blog-auto-post',
    title: 'Daily blog auto-post',
    description:
      'Publishes the next due IST blog slot (1–5/day). Catch-up also runs from the live cart-abandoned cron if this job is missing on Cronon.',
    scheduleUtc: '30 * * * *',
    scheduleIst: 'Every hour at :00 IST',
    endpointPath: '/api/cron/daily-blog',
    triggerKeys: [],
    cadence: 'daily',
    category: 'system_health',
  },
  ...
  {
    id: 'google-ads-funds-alert',
    jobName: 'wa-google-ads-funds-alert',
    title: 'Google Ads funds · below ₹1,000',
    description:
      'WhatsApp to alert numbers when Google Ads remaining account budget falls to ₹1,000 or below. Invoice accounts skip (API has no prepaid remaining).',
    scheduleUtc: '0 */3 * * *',
    scheduleIst: 'Every 3 hours',
    endpointPath: '/api/cron/google-ads-funds-alert',
    force: true,
    triggerKeys: [],
    cadence: 'daily',
    category: 'system_health',
