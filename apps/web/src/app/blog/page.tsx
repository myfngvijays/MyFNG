      ...
      <section className="bg-gradient-to-br from-gray-900 via-blue-900 to-gray-800 py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-5xl font-bold mb-4 text-white">Our Blog</h1>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="relative mb-6">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-transparent"
              />
            </div>
                ...
                {filteredPosts.map((post) => (
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="text-xl font-bold text-brand-secondary mb-3 group-hover:text-brand-primary transition line-clamp-2">
                        {post.title}
                      </h3>
