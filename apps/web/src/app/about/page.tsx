  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50/40 via-white to-white">
      ...
      <main className="pt-20 sm:pt-24">
        <div className="container mx-auto px-3 sm:px-6 py-8 sm:py-14">
          <div className="max-w-5xl mx-auto">
            <div className="rounded-2xl sm:rounded-3xl border border-gray-200/80 bg-white p-4 sm:p-10 shadow-lg sm:shadow-xl shadow-blue-900/5">
              <div className="text-sm font-bold text-brand-primary">MY FNG</div>
              <h1 className="mt-2 text-2xl sm:text-4xl font-extrabold text-gray-900 leading-tight">About MY FNG</h1>
              <div className="mt-5 sm:mt-6 space-y-5 sm:space-y-8 text-gray-700">
                <div className="rounded-xl sm:rounded-2xl border border-blue-100 bg-blue-50/40 p-4 sm:p-6 space-y-3 sm:space-y-4">
                ...
                <section className="rounded-xl sm:rounded-2xl border border-gray-200 bg-gray-50/60 p-4 sm:p-6">
                  <h2 className="text-lg sm:text-2xl font-bold text-gray-900 leading-snug">What We Do</h2>
                  ...
                  <ul className="mt-3 list-disc pl-5 space-y-1 marker:text-brand-primary leading-relaxed">
                    <li>Transparent</li>
                    <li>Professionally managed</li>
                    <li>Backed by process, warranty, and accountability</li>
                  </ul>
                  <p className="mt-3 leading-relaxed">Customers do not deal with workshops directly. MY FNG owns the experience.</p>
                </section>

                <section className="rounded-xl sm:rounded-2xl border border-gray-200 bg-gray-50/60 p-4 sm:p-6">
                  <h2 className="text-lg sm:text-2xl font-bold text-gray-900 leading-snug">How MY FNG Is Different</h2>
                  <p className="mt-3 leading-relaxed">
                    Unlike traditional platforms that only generate leads, MY FNG operates as a managed car care ecosystem.
                  </p>
                  <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="rounded-xl border border-gray-200 bg-white p-4 leading-relaxed">
                ...
                <section className="rounded-xl sm:rounded-2xl border border-gray-200 bg-gray-50/60 p-4 sm:p-6">
                  <h2 className="text-lg sm:text-2xl font-bold text-gray-900 leading-snug">Built for Scale, Powered by Technology</h2>
                  <p className="mt-3 leading-relaxed">
                  ...
                  <p className="mt-3 leading-relaxed">This is not just a service platform - it is infrastructure for the future of car care.</p>
                </section>

                <section className="rounded-xl sm:rounded-2xl border border-gray-200 bg-gray-50/60 p-4 sm:p-6">
                  <h2 className="text-lg sm:text-2xl font-bold text-gray-900 leading-snug">Our Vision</h2>
                  <p className="mt-3 leading-relaxed">
                ...
                <section className="rounded-xl sm:rounded-2xl border border-gray-200 bg-gray-50/60 p-4 sm:p-6">
                  <h2 className="text-lg sm:text-2xl font-bold text-gray-900 leading-snug">Our Mission</h2>
                ...
                <section className="rounded-xl sm:rounded-2xl border border-gray-200 bg-gray-50/60 p-4 sm:p-6">
                  <h2 className="text-lg sm:text-2xl font-bold text-gray-900 leading-snug">Where We Operate</h2>
                ...
                <section className="rounded-xl sm:rounded-2xl border border-gray-200 bg-gray-50/60 p-4 sm:p-6">
                  <h2 className="text-lg sm:text-2xl font-bold text-gray-900 leading-snug">Why Customers Trust MY FNG</h2>
                  <p className="mt-3 leading-relaxed">
              ...
              <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row gap-3">
                ...
                <Link
                  href="/book-service"
                  className="w-full sm:w-auto inline-flex items-center justify-center rounded-xl border border-gray-200 bg-white px-5 py-3 text-gray-900 font-bold hover:bg-gray-50 transition"
                >
                  Book Service
                </Link>
              </div>
