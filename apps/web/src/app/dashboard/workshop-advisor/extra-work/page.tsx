    ...
    <DashboardLayout role="workshop_supervisor">
      <div className="mx-auto w-full max-w-6xl min-w-0 space-y-3 overflow-x-hidden pb-8 sm:space-y-4">
        <AdvisorPageHeader
          ...
          href="/dashboard/workshop-advisor/extra-work"
        />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          ...
          <div className="rounded-2xl border border-red-200 bg-gradient-to-br from-red-50 to-red-100 p-4 shadow-sm">
            <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="rounded-2xl border border-green-200 bg-gradient-to-br from-green-50 to-green-100 p-4 shadow-sm sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2 sm:gap-3">
        ...
        {requests.length === 0 ? (
          ...
          <div className="space-y-3 sm:space-y-4">
            {groupedRequests.map((group) => (
              <div 
                key={group.lead_id}
                className={`rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition-shadow hover:shadow-md border-l-4 ${
