...
export default function CompanyMechanicRSATaskDetailPage() {
  ...
  return (
    <DashboardLayout role="company_mechanic_rsa">
      <div className="space-y-4">
        <div>
          <h1 className="text-2xl font-bold text-text-heading">Task Detail</h1>
          <p className="text-sm text-gray-600 mt-1">Task ID: {taskId}</p>
        </div>
        {loading ? (
          <div className="card p-4 text-center text-gray-500">Loading...</div>
        ) : !task ? (
          <div className="card p-4 text-center text-gray-500">Task not found</div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="card p-4">
              ...
              <div className="text-sm">{task.service_location || '—'}</div>
            </div>
            <div className="card p-4">
