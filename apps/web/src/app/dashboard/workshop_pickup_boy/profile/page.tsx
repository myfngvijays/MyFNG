    ...
    <DashboardLayout role="workshop_pickup_boy">
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-brand-secondary to-brand-primary text-white p-6 rounded-lg shadow-lg">
          ...
          <p className="text-white font-medium mt-1">View and manage your profile information</p>
        </div>
        ...
        <div className="card">
          <div className="flex items-start justify-between mb-6">
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                <button className="absolute bottom-0 right-0 bg-white rounded-full p-2 shadow-lg border-2 border-gray-200 hover:bg-gray-50 transition">
                  <Camera className="w-4 h-4 text-gray-600" />
                </button>
              </div>
              <div>
                <h2 className="text-2xl font-bold text-text-heading">{profile.full_name}</h2>
                <p className="text-gray-600 font-medium">Pickup Boy / Driver</p>
            ...
            {!editing ? (
              <button
                ...
                className="btn bg-brand-primary hover:bg-brand-secondary text-white"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-bold text-text-heading mb-4 border-b pb-2">
                Basic Information
              </h3>
              ...
              <div className="space-y-2">
                ...
                {editing ? (
                  ...
                  <p className="text-text-heading font-semibold">{profile.full_name}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-text-heading font-semibold">{profile.email}</p>
              ...
              <div className="space-y-2">
                ...
                {editing ? (
                  ...
                  <p className="text-text-heading font-semibold">{profile.phone || 'Not provided'}</p>
                )}
              </div>
            </div>
              ...
              {profile.workshop ? (
                <>
                  <div className="space-y-2">
                    ...
                    <p className="text-text-heading font-semibold">{profile.workshop.name}</p>
                  </div>
                ...
                <p className="text-gray-500">No workshop assigned</p>
              )}
          ...
          <>
            ...
            <div className="card bg-gradient-to-br from-brand-primary to-brand-secondary text-white">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-xl font-bold mb-2 text-yellow-300">Overall Performance Score</h3>
                  <div className="flex items-baseline gap-2">
                    <p className="text-5xl font-bold">{overallScore}%</p>
                    <span className={`px-3 py-1 rounded-full text-sm font-bold ${performanceRating.bg} ${performanceRating.color}`}>
                      {performanceRating.label}
                    </span>
                  </div>
                  <p className="text-white/80 mt-2">Based on last 30 days</p>
                </div>
                <Award className="w-20 h-20 text-yellow-300 opacity-50" />
              </div>
            </div>
            ...
            <div className="card">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="p-4 bg-blue-50 rounded-lg border-l-4 border-blue-500">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-gray-700">Total Pickups</span>
                    <Truck className="w-5 h-5 text-blue-500" />
                  </div>
                  <p className="text-3xl font-bold text-blue-600">{metrics.total_pickups}</p>
                ...
                <div className="p-4 bg-purple-50 rounded-lg border-l-4 border-purple-500">
                  ...
                  <p className="text-3xl font-bold text-purple-600">{metrics.total_drops}</p>
                  <p className="text-sm text-green-600 font-medium mt-1">
              ...
              {/* Quality Metrics */}
              <div className="space-y-4">
                <h4 className="font-bold text-gray-700 mb-3">Quality Metrics</h4>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium text-gray-700">OTP Success Rate</span>
                    </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <Camera className="w-4 h-4 text-gray-600" />
                      <span className="text-sm font-medium text-gray-700">Photo Compliance Rate</span>
                    </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                <div className="p-4 bg-gray-50 rounded-lg">
                  <p className="text-sm text-gray-600 mb-1">Avg. Pickup Time</p>
                  <p className="text-2xl font-bold text-gray-800">
                    {metrics.avg_pickup_time.toFixed(0)} mins
                  </p>
                </div>
                <div className="p-4 bg-gray-50 rounded-lg">
                  <p className="text-sm text-gray-600 mb-1">Avg. Drop Time</p>
                  <p className="text-2xl font-bold text-gray-800">
