    ...
    <DashboardLayout role="rsa_manager">
      <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-red-600 to-orange-500 text-white p-6 rounded-lg shadow-lg -mx-6 -mt-6 mb-8">
          <h1 className="text-3xl font-bold text-white drop-shadow-lg">📋 RSA Leads</h1>
          <p className="text-white/90 font-medium mt-1">Manage all RSA leads and assignments</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4">RSA Leads ({filteredLeads.length})</h2>
                      ...
                      <div className="flex items-center gap-4">
                        {!lead.assigned_manager_id && (
                          <button
                            ...
                            className="px-4 py-2 bg-purple-600 text-white text-sm rounded-lg hover:bg-purple-700 transition-colors z-10 relative"
                          >
                            Claim
                          </button>
                        )}
