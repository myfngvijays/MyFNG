...
export default function EditBlogPage() {
  ...
  // Digital Author cannot access version history
  ...
  return (
    <DashboardLayout role="digital_marketing">
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-text-body mt-1">Update blog content and settings</p>
            </div>
          </div>
        ...
        {/* Version History - Not available for Digital Author */}
        {false && versions.length > 0 && (
          <div className="card bg-yellow-50 border-yellow-200">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="font-semibold text-text-heading">Version History</h3>
                <p className="text-sm text-gray-600">Restore previous versions if needed</p>
              </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-primary focus:border-transparent resize-y"
                  rows={3}
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-primary focus:border-transparent bg-white"
                  >
          ...
          <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-3 sm:gap-4">
            <Link href="/dashboard/digital_author/blogs" className="w-full sm:w-auto">
