  ...
  return (
    <DashboardLayout role="workshop_supervisor">
      <div className="space-y-4 sm:space-y-5 md:space-y-6">
        <div>
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-text-heading">Job Assignments</h1>
          <p className="text-text-body text-xs sm:text-sm mt-1 sm:mt-2">Monitor and manage mechanic job assignments</p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          ...
          <div className="card bg-red-50 sm:col-span-2 lg:col-span-1">
