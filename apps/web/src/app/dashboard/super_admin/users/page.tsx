...
const AVAILABLE_ROLES = [
  ...
  { code: 'WORKSHOP_ADMIN', name: 'Workshop Admin', color: 'orange' },
  { code: 'WORKSHOP_SUPERVISOR', name: 'Workshop Supervisor', color: 'indigo' },
  { code: 'WORKSHOP_MECHANIC', name: 'Workshop Mechanic', color: 'teal' },
  { code: 'PICKUP_BOY', name: 'Pickup Boy', color: 'green' },
