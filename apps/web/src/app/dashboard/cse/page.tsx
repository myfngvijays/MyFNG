      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Customer Service Executive - Manage all customer interactions</p>
          </div>
          <Link
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow border-l-4 border-yellow-500">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{stats.pending_resolutions}</p>
              </div>
              <Clock className="w-10 h-10 text-yellow-500" />
            </div>
            <Link href="/dashboard/cse/tickets?status=IN_PROGRESS" className="text-sm text-indigo-600 hover:underline mt-2 block">
              View all →
            </Link>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow border-l-4 border-blue-500">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{stats.pending_callbacks}</p>
              </div>
              <Phone className="w-10 h-10 text-blue-500" />
            </div>
            <Link href="/dashboard/cse/callbacks" className="text-sm text-indigo-600 hover:underline mt-2 block">
              View all →
            </Link>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow border-l-4 border-purple-500">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">Vehicle Pickup Issues</p>
                <p className="text-3xl font-bold text-gray-900">{stats.vehicle_pickup_issues}</p>
              </div>
              <Truck className="w-10 h-10 text-purple-500" />
            </div>
            <Link href="/dashboard/cse/tickets?category=PICKUP_DELAY" className="text-sm text-indigo-600 hover:underline mt-2 block">
              View all →
            </Link>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow border-l-4 border-orange-500">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{stats.delivery_issues}</p>
              </div>
              <Truck className="w-10 h-10 text-orange-500" />
            </div>
            <Link href="/dashboard/cse/tickets?category=DROP_DELAY" className="text-sm text-indigo-600 hover:underline mt-2 block">
              View all →
            </Link>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow border-l-4 border-red-600">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">Repair Complaints</p>
                <p className="text-3xl font-bold text-gray-900">{stats.repair_complaints}</p>
              </div>
              <Wrench className="w-10 h-10 text-red-600" />
            </div>
            <Link href="/dashboard/cse/tickets?category=SERVICE_QUALITY_COMPLAINT" className="text-sm text-indigo-600 hover:underline mt-2 block">
              View all →
            </Link>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow border-l-4 border-green-500">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">Billing/Invoice Queries</p>
                <p className="text-3xl font-bold text-gray-900">{stats.billing_invoice_queries}</p>
              </div>
              <DollarSign className="w-10 h-10 text-green-500" />
            </div>
            <Link href="/dashboard/cse/tickets?category=INVOICE_BILLING_ISSUE" className="text-sm text-indigo-600 hover:underline mt-2 block">
              View all →
            </Link>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow border-l-4 border-yellow-600">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">Ratings Pending</p>
                <p className="text-3xl font-bold text-gray-900">{stats.customer_ratings_pending}</p>
              </div>
              <Star className="w-10 h-10 text-yellow-600" />
            </div>
            <Link href="/dashboard/cse/ratings" className="text-sm text-indigo-600 hover:underline mt-2 block">
              View all →
            </Link>
          </div>
        </div>
