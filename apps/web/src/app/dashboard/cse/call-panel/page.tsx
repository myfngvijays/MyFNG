    ...
    <DashboardLayout role="customer_service_executive">
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">Search and view customer lead details</p>
        </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center gap-2 text-sm">
                            ...
                            <span className="font-medium">{lead.vehicle_number}</span>
                          </div>
                          {lead.vehicle_model && (
                            <div className="text-sm text-gray-600">{lead.vehicle_model}</div>
                          )}
                        </div>
                        ...
                        {lead.workshop && (
                          <div className="space-y-2">
                            <div className="flex items-center gap-2 text-sm">
                              ...
                              <span className="font-medium">{lead.workshop.name}</span>
                            </div>
                            {lead.workshop.phone && (
                              <div className="text-sm text-gray-600">{lead.workshop.phone}</div>
                            )}
                            {lead.workshop.city && (
                        ...
                        <div className="space-y-2">
                          {lead.assigned_mechanic && (
                            <div className="flex items-center gap-2 text-sm">
                              ...
                              <span className="font-medium">{lead.assigned_mechanic.full_name}</span>
                            </div>
                          )}
                          {lead.assigned_supervisor && (
                            <div className="flex items-center gap-2 text-sm">
                              ...
                              <span className="font-medium">{lead.assigned_supervisor.full_name}</span>
                            </div>
                          )}
                          {lead.pickup_boy && (
                            <div className="flex items-center gap-2 text-sm">
                              ...
                              <span className="font-medium">{lead.pickup_boy.full_name}</span>
                            </div>
                          )}
                        </div>
                      </div>
