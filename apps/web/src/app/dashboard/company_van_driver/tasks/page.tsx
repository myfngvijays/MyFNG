...
export default function CompanyVanDriverTasksPage() {
  ...
  return (
    <DashboardLayout role="company_van_driver">
      <div className="space-y-4">
        <div>
          <h1 className="text-2xl font-bold text-text-heading">My Trips</h1>
        </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              {!loading && tasks.length === 0 && (
                <tr>
                  <td colSpan={5} className="px-4 py-6 text-center text-gray-500">No trips found</td>
                </tr>
              )}
              {tasks.map((task) => (
