...
export async function GET() {
  ...
  const { data: leads, error } = await supabaseAdmin
    .from('service_leads')
    .select('id, lead_number, status, vehicle_number, vehicle_make, vehicle_model, fuel_type, service_type, service_type_ids, subservice_ids, description, estimated_amount, created_at, customer_phone, address, city, state, pincode')
