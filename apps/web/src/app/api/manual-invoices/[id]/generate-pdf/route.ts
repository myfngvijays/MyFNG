...
export async function GET(request: Request, { params }: { params: { id: string } }) {
  try {
    ...
    const htmlContent = generateManualInvoiceHTML(invoice, autoPrint);
...
function generateManualInvoiceHTML(invoice: any, autoPrint: boolean): string {
