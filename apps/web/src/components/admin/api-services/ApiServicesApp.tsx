...
export default function ApiServicesApp() {
  ...
  const menuHrefMap = useMemo(() => {
    ...
    const aliases: Record<string, string> = {
      ...
      'dlt sms': '/dashboard/super_admin/dlt-sms',
      'dlt dashboard': '/dashboard/super_admin/dlt-sms',
      'header sms': '/dashboard/super_admin/dlt-sms?section=headers',
      'content templates': '/dashboard/super_admin/dlt-sms?section=content',
      'telemarketers': '/dashboard/super_admin/dlt-sms?section=telemarketers',
      'send sms': '/dashboard/super_admin/dlt-sms?section=compose',
