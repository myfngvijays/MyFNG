    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.profileHeader}>
          ...
          <Text style={styles.profileName}>{profile?.name || profile?.full_name || 'Marketing'}</Text>
          <Text style={styles.profileRole}>{profile?.role?.role_name || 'Digital Marketing'}</Text>
        </View>
