...
export default function CVTProfileScreen() {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.profileHeader}>
          ...
          <Text style={styles.profileName}>{profile?.name || profile?.full_name || 'Van Technician'}</Text>
          <Text style={styles.profileRole}>{profile?.role?.role_name || 'Company Van Technician'}</Text>
        </View>
