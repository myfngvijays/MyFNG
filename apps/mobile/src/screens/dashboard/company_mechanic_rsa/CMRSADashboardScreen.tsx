...
export default function CMRSADashboardScreen() {
  ...
  return (
    <View style={styles.container}>
      <DashboardHeader title="RSA Mechanic Dashboard" onBack={() => navigation.goBack()} />
      ...
      >
        ...
        <View style={styles.actionsSection}>
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('CMRSATasks')}
          >
          ...
          <TouchableOpacity
            style={styles.actionButton}
            onPress={() => navigation.navigate('CMRSAHistory')}
          >
            <Text style={styles.actionIcon}>📜</Text>
          ...
          <TouchableOpacity
            style={styles.actionButton}
            onPress={() => navigation.navigate('CMRSAProfile')}
          >
            <Text style={styles.actionIcon}>👤</Text>
