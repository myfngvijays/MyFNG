...
const AVAILABLE_ROLES = [
  ...
  { code: 'WORKSHOP_ADMIN', name: 'Workshop Admin', icon: 'store', color: COLORS.orange },
  { code: 'WORKSHOP_SUPERVISOR', name: 'Workshop Supervisor', icon: 'account-supervisor', color: COLORS.indigo },
  { code: 'WORKSHOP_MECHANIC', name: 'Workshop Mechanic', icon: 'wrench', color: COLORS.teal },
  { code: 'PICKUP_BOY', name: 'Pickup Boy', icon: 'car-pickup', color: COLORS.green },
