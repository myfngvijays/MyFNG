...
const SECTIONS = [
  {
    ...
    items: [
      ...
      { title: 'QC Queue', body: 'Complete jobs ka quality check — approve / reject. Pass ke baad Order Summary / Billing.' },
      ...
      { title: 'Daily Report', body: 'End-of-day summary. QC pass ke baad lead pe tap = Order Summary.' },
