...
const styles = StyleSheet.create({
  ...
  viewAll: { flexDirection: 'row', alignItems: 'center', gap: 2, marginTop: 6 },
  viewAllText: { fontSize: 11, fontWeight: '700', color: COLORS.primary },
  desc: { marginTop: 8, fontSize: 11, color: COLORS.textSecondary },
  added: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 8 },
  addedText: { fontSize: 11, fontWeight: '700', color: '#059669' },
  addBtn: {
    marginTop: 8,
    alignSelf: 'stretch',
    flexDirection: 'row',
