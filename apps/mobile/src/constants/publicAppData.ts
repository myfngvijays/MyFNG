...
export const FAQ_CATEGORIES: FaqCategory[] = [
  {
    ...
    items: [
      ...
      { q: 'How can I book a service appointment with My FNG?', a: 'You can book service via MyFNG AI Booking Agent - https://myfng.in/misa-ai or online through our website www.myfng.in/book-service or by calling our customer support. We offer flexible scheduling to accommodate your convenience.' },
