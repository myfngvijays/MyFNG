...
export const ENV = {
  ...
  // Production API — localhost breaks on physical devices / Android emulator.
  APP_URL: process.env.EXPO_PUBLIC_API_URL || 'https://myfng.in',
  API_URL: process.env.EXPO_PUBLIC_API_URL || 'https://myfng.in',
};
