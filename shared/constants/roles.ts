...
export const ROLE_LABELS: Record<UserRole, string> = {
  ...
  [UserRole.WORKSHOP_ADMIN]: 'Workshop Admin',
  [UserRole.WORKSHOP_SUPERVISOR]: 'Workshop Supervisor',
  [UserRole.WORKSHOP_MECHANIC]: 'Workshop Mechanic',
  [UserRole.WORKSHOP_PICKUP_BOY]: 'Workshop Pickup Boy',
...
export const ROLE_DESCRIPTIONS: Record<UserRole, string> = {
  ...
  [UserRole.LEAD_MANAGER]: 'Handles all normal service leads assignment to workshops',
...
export const ROLE_HIERARCHY = {
  ...
  internal_staff: [UserRole.TELECALLER, UserRole.CUSTOMER_SERVICE_EXECUTIVE, UserRole.AUDITOR, UserRole.ACCOUNTS_TEAM],
